...
<body>
	...
	<p>
		<a href="${setting.siteUrl}/password/reset.html?username=${username}&key=${safeKey.value}" target="_blank">${setting.siteUrl}/reset.html?username=${username}&key=${safeKey.value}</a>
	</p>
