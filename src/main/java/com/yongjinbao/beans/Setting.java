...
public class Setting implements Serializable {
	...
	/** 缓存过期时间参数 **/
	private Integer redis_expire_5Min;
	private Integer redis_expire_10Min;
	private Integer redis_expire_30Min;
	private Integer redis_expire_1Hour;
	private Integer redis_expire_3Hour;
	private Integer redis_expire_12Hour;

	/** 1/2级区域和第3级区域的缓存最大页数 **/
	private Integer redis_level1and2_maxPage;
	public Integer getRedis_expire_5Min() {
		return redis_expire_5Min;
	}

	public void setRedis_expire_5Min(Integer redis_expire_5Min) {
		this.redis_expire_5Min = redis_expire_5Min;
	}

	public Integer getRedis_level1and2_maxPage() {
		return redis_level1and2_maxPage;
	}

	public void setRedis_level1and2_maxPage(Integer redis_level1and2_maxPage) {
		this.redis_level1and2_maxPage = redis_level1and2_maxPage;
	}

	public Integer getRedis_level3_maxPage() {
		return redis_level3_maxPage;
	}

	public void setRedis_level3_maxPage(Integer redis_level3_maxPage) {
		this.redis_level3_maxPage = redis_level3_maxPage;
	}

	private Integer redis_level3_maxPage;
	
	public Integer getRedis_expire_10Min() {
		return redis_expire_10Min;
	}

	public void setRedis_expire_10Min(Integer redis_expire_10Min) {
		this.redis_expire_10Min = redis_expire_10Min;
	}

	public Integer getRedis_expire_30Min() {
		return redis_expire_30Min;
	}

	public void setRedis_expire_30Min(Integer redis_expire_30Min) {
		this.redis_expire_30Min = redis_expire_30Min;
	}

	public Integer getRedis_expire_1Hour() {
		return redis_expire_1Hour;
	}

	public void setRedis_expire_1Hour(Integer redis_expire_1Hour) {
		this.redis_expire_1Hour = redis_expire_1Hour;
	}

	public Integer getRedis_expire_3Hour() {
		return redis_expire_3Hour;
	}

	public void setRedis_expire_3Hour(Integer redis_expire_3Hour) {
		this.redis_expire_3Hour = redis_expire_3Hour;
	}

	public Integer getRedis_expire_12Hour() {
		return redis_expire_12Hour;
	}

	public void setRedis_expire_12Hour(Integer redis_expire_12Hour) {
		this.redis_expire_12Hour = redis_expire_12Hour;
	}
