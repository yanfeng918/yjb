package com.yongjinbao.houseProperty.service;
 ...
 */
public interface IHouseInfoPropertyService extends IBaseService<HouseInfoProperty,Integer>{
	 ...
	 * 购买数据时添加收支明细和我的查看数据
	 */
	public void addIncomeExpenseAndBrowseInfo(Member houseMember, Member loginMember, HouseInfoProperty houseInfoProperty);
	
	/**
	 * 获取房源信息所属人员
	 * @param houseInfoProperty 房源信息
...
//     * 修改我发布的房源
//     */
//    public boolean updateMyReleaseInfo(HouseInfoNew houseInfoProperty);
